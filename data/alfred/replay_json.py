...
if __name__ == "__main__":
    ...
    data_dir = "/data/anthony/alfred/data/json_2.1.0/"
    
    all_json_files = list(glob.glob("/data/anthony/alfred/data/json_2.1.0/*/*/*/*.json"))
    ...
    def generate_traj_metadata(json_files):
        ...
        for i, json_file in enumerate(json_files):
            ...
            parts = json_file.replace(data_dir, "").split('/')
